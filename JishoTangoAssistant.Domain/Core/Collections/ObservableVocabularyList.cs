...
using JishoTangoAssistant.Domain.Models.Common.Data.ListOperations;

namespace JishoTangoAssistant.Domain.Core.Collections;
...
public sealed class ObservableVocabularyList : IList<VocabularyItem>, INotifyCollectionChanged, INotifyPropertyChanged
{
    ...
    private readonly Stack<ListOperation> undoOperationStack = new();
    ...
    public bool Contains(VocabularyItem item) => vocabularyDictionary.ContainsKey(item.Word) && vocabularyDictionary[item.Word].Contains(item);
